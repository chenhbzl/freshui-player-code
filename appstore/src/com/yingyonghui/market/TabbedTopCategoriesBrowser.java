...
public class TabbedTopCategoriesBrowser extends TabActivity
  implements TabHost.OnTabChangeListener
{
  ...
  private static final int TAB_ID_PREINSTALL = 2;
  private static final String TAB_PREINSTALL = "preinstall";
  ...
  private void initTabs()
  {
    ...
    TabHost.TabSpec localTabSpec = this.mTabHost.newTabSpec("app");
    ...
    localTextView.setText(2131296309);
    ...
    try
    {
      ...
      String str1 = FilteredCategoryListActivity.class.getName();
      localIntent1.setClassName(this, str1);
      localIntent1.putExtra("_id", 30);
      ...
      localTextView.setBackgroundResource(2130837750);
      localTextView.getBackground().setCallback(null);
      localTextView.setText(2131296310);
      ...
      try
      {
        ...
        label318: this.tabViews.add(localTextView);
        Intent localIntent2 = new Intent();
        String str2 = FilteredCategoryListActivity.class.getName();
        localIntent2.setClassName(this, str2);
        localIntent2.putExtra("_id", 40);
        localIntent2.putExtra("header", 0);
        localTabSpec.setContent(localIntent2);
        this.mTabHost.addTab(localTabSpec);
        localTabSpec = this.mTabHost.newTabSpec("preinstall");
        localTextView = (TextView)localLayoutInflater.inflate(2130903112, null);
        localTextView.setBackgroundResource(2130837750);
        localTextView.getBackground().setCallback(null);
        localTextView.setText(2131296398);
        ...
        try
        {
          ...
          label491: this.tabViews.add(localTextView);
          Intent localIntent3 = new Intent();
          String str3 = FilteredCategoryListActivity.class.getName();
          localIntent3.setClassName(this, str3);
          localIntent3.putExtra("_id", 8);
  ...
  {
    TabHost.TabSpec localTabSpec1 = this.mTabHost.newTabSpec("app");
    ArrayList localArrayList = new ArrayList();
    this.tabViews = localArrayList;
    LayoutInflater localLayoutInflater = (LayoutInflater)getSystemService("layout_inflater");
    ...
    localTextView1.setText(2131296309);
    float f1 = this.labelTextSize;
    localTextView1.setTextSize(f1);
    String str1 = getResources().getString(2131296309);
    ...
    TabHost.TabSpec localTabSpec2 = this.mTabHost.newTabSpec("game");
    ...
    localTextView3.setText(2131296398);
    float f3 = this.labelTextSize;
    localTextView3.setTextSize(f3);
    String str5 = getResources().getString(2131296398);
    localTabSpec3.setIndicator(str5);
    this.tabViews.add(localTextView3);
    Intent localIntent3 = new Intent();
    String str6 = FilteredCategoryListActivity.class.getName();
  ...
  {
    int i;
    if ("preinstall".equals(paramString))
    {
      i = 2;
      if (DeviceUtil.getSDKVersionInt() != 3)
        break label43;
 ...
 * Qualified Name:     com.yingyonghui.market.TabbedTopCategoriesBrowser
