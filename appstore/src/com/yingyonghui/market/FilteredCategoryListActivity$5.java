...
@EnclosingMethod
class FilteredCategoryListActivity$5
  implements Observer
{
  public void update(Observable paramObservable, Object paramObject)
  {
    if (paramObject != null)
    {
      Message localMessage1 = Message.obtain(FilteredCategoryListActivity.access$9(this.this$0), 0, paramObject);
 ...
 * Qualified Name:     com.yingyonghui.market.FilteredCategoryListActivity.5
